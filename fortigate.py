...
class FortiGate(Responder):
    ...
    def run(self):
        ...
        r2 = requests.get(("https://" + self.fortigate_ip + ":" + self.fortigate_port + payload + self.fortigate_addgrpaddrgrp + "?access_token=" + self.fortigate_api), verify=False)
        ...
        r3 = requests.put(("https://" + self.fortigate_ip + ":" + self.fortigate_port + payload + self.fortigate_addgrpaddrgrp + "?access_token=" + self.fortigate_api), verify=False, data=body3)
